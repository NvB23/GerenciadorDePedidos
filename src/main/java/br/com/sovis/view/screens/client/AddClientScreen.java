...
public class AddClientScreen extends Container {
    ...
    public AddClientScreen(Container containerDeVolta) {
    ...
    public void initUI() {
        ...
        add(new TabBar(new HomeScreen(), "Adicionar Cliente", saveBotao), 0, 0, FILL, PARENTSIZE + 8);

        add(new ContentFieldClient(), 0, TOP + 80, FILL, FILL);
    }
